<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Instrumenta.Vista.index" %>
    ...
    <div class="container" style="padding-top: 2.5rem;">
        <div class="row">
            <div class="col-xl-4 col-md-7 mb-4">
                <div class="card mb-3 primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Comenzar</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Instrumentación</div>
                            </div>
                            <div class="col-auto">
                                <a href="instrumentacion.aspx" class="stretched-link"></a>
                                <i class="fas fa-chess-board fa-2x  text-gray-300" href="#"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Competencias</div>
                            </div>
                            <div class="col-auto">
